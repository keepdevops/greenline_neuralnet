...
def bcipo_dropout_stock(x, y, timestamps, activation='linear', iterations=1000):
    ...
    # Initialize Dropout NN and history
    ...
    # Parameters for BCIPO-Dropout
    N = 10  # Number of chaos states
    K = 5   # Number of dropout samples
...
if __name__ == "__main__":
    ...
    w, b, final_loss = bcipo_dropout_stock(x, y, timestamps, activation='linear')
